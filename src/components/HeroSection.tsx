					...
					<div className="space-y-8">
						<div className="space-y-4">
							...
							<p className="text-xl text-muted-foreground leading-relaxed max-w-lg">
								AI Product Engineer building the future of agentic workflows and
								intelligent systems. Transforming complex problems into elegant
								AI solutions.
							</p>
						</div>
						...
						<div className="flex items-center space-x-6">
							...
							<div className="flex space-x-4">
								<a
									href="https://github.com/davideasaf"
									target="_blank"
