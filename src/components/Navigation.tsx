      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-8">
            {navItems.map((item) => {
              const isActive =
                item.type === "hash" ? activeSection === item.id : location.pathname === item.path;
            ...
            <Button variant="glow" size="sm" onClick={() => goToHash("contact")}>
              Let's Connect
            </Button>
          </div>
        ...
        {isOpen && (
          <div className="md:hidden pb-4">
            <div className="flex flex-col space-y-2">
              ...
              <Button variant="glow" size="sm" className="mt-2" onClick={() => goToHash("contact")}>
                Let's Connect
              </Button>
            </div>
          </div>
