...
<a href="../../src/assets/blog/monarch-money-workflow.png" target="_blank" style={{ display: 'block', maxWidth: '650px', margin: '0 auto', cursor: 'pointer' }}>

![Monarch Money Claude Skill Workflow](../../src/assets/blog/monarch-money-workflow.png "sizes=(min-width: 768px) 720px, 100vw; widths=400,800,1200; formats=avif,webp,jpg; q=85")

</a>

**Key insight**: Notice how Claude orchestrates multiple focused scripts - finding transactions, loading cached categories, validating splits, and executing changes. Each script does one thing well, and Claude chains them together intelligently. *(Click diagram to enlarge)*
...
Want to see how it works? The complete skill implementation is open source:

**Repository:** [davideasaf/davideasaf-marketplace](https://github.com/davideasaf/davideasaf-marketplace/tree/main/monarch-money/skills/monarch-money-handling)

Key files to explore:
- [`SKILL.md`](https://github.com/davideasaf/davideasaf-marketplace/blob/main/monarch-money/skills/monarch-money-handling/SKILL.md) - Complete skill documentation
- [`scripts/`](https://github.com/davideasaf/davideasaf-marketplace/tree/main/monarch-money/skills/monarch-money-handling/scripts) - TypeScript implementation
- [`SCRIPTS_REFERENCE.md`](https://github.com/davideasaf/davideasaf-marketplace/blob/main/monarch-money/skills/monarch-money-handling/SCRIPTS_REFERENCE.md) - Detailed script documentation

The skill uses the [monarchmoney-ts](https://github.com/keithah/monarchmoney-ts) SDK with custom GraphQL queries adapted from browser network traffic.
...
*Want to learn more about building Claude Skills? Check out the [official documentation](https://docs.anthropic.com/en/docs/build-with-claude/claude-skills). Want to try this skill? Get it from the [davideasaf-marketplace repository](https://github.com/davideasaf/davideasaf-marketplace/tree/main/monarch-money/skills/monarch-money-handling).*
